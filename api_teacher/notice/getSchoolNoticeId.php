...
class NoticeApi
{
    ...
    public function fetchNotices()
    {
        ...
        try {
            ...
            $lastNoticeId = $this->getLastNoticeId($schoolId);
    ...
    private function getLastNoticeId($schoolId)
    {
        $sql = "SELECT MAX(id) as last_notice_id FROM notice WHERE school_id = :schoolId AND class_id = '0'";
    ...
    {
        $sql = "SELECT school_id FROM teacher WHERE username = :username";
