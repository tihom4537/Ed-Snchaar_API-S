...
{   private $headers;
    ...
    public function fetchSyllabusCovered()
    {
    ...
    (COUNT(DISTINCT CASE WHEN status = 1 THEN subject_content END) / COUNT(DISTINCT subject_content)) * 100 AS percentage_covered
FROM
    syllabus
WHERE
    school_id = :school_id
