    ...
    public function fetchClassStudents()
{
    ...
    $classQuery = "
        SELECT u.username, u.name, u.class_id, u.roll_no, u.boarder,
               f.plan, f.title, f.base_fee, f.miscellaneous_charges,f.total_fees,f.total_paid, f.paid_status, f.paid_status, f.transaction_id, f.receipt_no, f.due_date, f.id as fee_id
        FROM users u
