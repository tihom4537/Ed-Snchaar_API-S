...
{  private $conn;
    ...
    // Function to get teachers with login information
public function getTeachers($school_id)
{
    $sql = "SELECT teacher.*, login_teacher.password
            FROM teacher
            JOIN login_teacher ON teacher.username = login_teacher.username
