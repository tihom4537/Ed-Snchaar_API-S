    ...
    if ($this->validateApiKey($decryptedApiKey)) {
        ...
        try {
            if ($method === "GET") {
                ...
                if ($exam_id !== null) {
                    $this->getMarks($exam_id, $username, $subject);
                } else {
...
// Function to get marks for a specific student and exam
public function getMarks($exam_id, $username, $subject)
{
    $sql = "SELECT * FROM marks WHERE exam_id = :exam_id AND student_id = :username AND subject = :subject";
