    ...
    public function fetchCommunicationUpdate()
{
    ...
    try {
        // Fetch distinct sender usernames with names from the teacher table
        $senderUsernames = $this->getSenderUsernamesWithTeacherNames($username);
...
private function getSenderUsernamesWithTeacherNames($receiverUsername)
{
    $sql = "SELECT DISTINCT c.sender_username, t.name 
            FROM communication c
            JOIN teacher t ON c.sender_username = t.username
